...
// const GUEST_BASE_URL = `${import.meta.env.VITE_API_URL}/guest`;
...
//       `${import.meta.env.VITE_API_URL}/guest/quizzes`,
//       {
//         method: "GET",
//         headers: {
//           Authorization: `Bearer ${token}`,
...
//     const res = await fetch(
//       `${import.meta.env.VITE_API_URL}/guest/quiz/${quizId}`,
//       {
//         method: "GET",
//         headers: {
//           Authorization: `Bearer ${token}`,
...
//   try {
//     const res = await fetch(
//       `${import.meta.env.VITE_API_URL}/guest/submit`,
//       {
//         method: "POST",
//         headers: {
//           Authorization: `Bearer ${token}`,
