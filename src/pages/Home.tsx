...
//           </div>
//           <div className="pt-4">
//             <h3 className="text-4xl font-extrabold text-gray-900 mb-4">Discussion Room</h3>
//             <p className="text-base text-gray-700 leading-relaxed mb-8 max-w-md">
//               World leaders gathered at the Global Climate Summit to discuss urgent climate action, emissions reduction, and renewable energy transitions.
//             </p>
...
//         <div className="flex-shrink-0 w-[780px] flex items-start gap-10">
//           <div className="flex-shrink-0">
//             <img src={discussion1} alt="Discussion Room" className="w-96 h-80 object-cover rounded-3xl shadow-2xl" />
//           </div>
//           <div className="pt-4">
//             <h3 className="text-4xl font-extrabold text-gray-900 mb-4">Discussion Room</h3>
//             <p className="text-base text-gray-700 leading-relaxed mb-8 max-w-md">
...
//             Math.round((document.getElementById("unique-slider")?.scrollLeft || 0) / 790) === index
//               ? "bg-[#001BB7] w-10"
...
//   <path d="M14.5 8.5L9.5 11.5" stroke="white" strokeWidth="2" strokeLinecap="round"/>
//   <path d="M14.5 15.5L9.5 12.5" stroke="white" strokeWidth="2" strokeLinecap="round"/>
// </svg>
...
//                 <h4 className="text-[#0E2A46] font-bold text-lg leading-tight">Esther Howard</h4>
//                 <p className="text-[#704FE6] text-xs mt-1">Junior Instructor</p>
//               </div>
...
//             <div className="absolute left-1/2 -translate-x-1/2 bottom-6 w-[240px] h-[60px] bg-white rounded-lg shadow-2xl border border-purple-100 flex items-center px-5">
//               <div className="flex-1">
//                 <h4 className="text-[#0E2A46] font-bold text-lg leading-tight">Beverly Hathcock</h4>
//                 <p className="text-[#704FE6] text-xs mt-1">Junior Instructor</p>
//               </div>
//               <div className="w-10 h-10 bg-[#E9E2FF] rounded-full flex items-center justify-center relative overflow-hidden">
//                 <div className="absolute -left-1 top-1/2 -translate-y-1/2 w-[18px] h-[7px] bg-[#704FE6] rotate-[-30deg]" />
...
//             <div className="absolute left-1/2 -translate-x-1/2 bottom-6 w-[240px] h-[60px] bg-white rounded-lg shadow-2xl border border-purple-100 flex items-center px-5">
//               <div className="flex-1">
//                 <h4 className="text-[#0E2A46] font-bold text-lg leading-tight">Donald Gonzales</h4>
//                 <p className="text-[#704FE6] text-xs mt-1">Junior Instructor</p>
//               </div>
//               <div className="w-10 h-10 bg-[#E9E2FF] rounded-full flex items-center justify-center relative overflow-hidden">
//                 <div className="absolute -left-1 top-1/2 -translate-y-1/2 w-[18px] h-[7px] bg-[#704FE6] rotate-[-30deg]" />
...
//             <div className="absolute left-1/2 -translate-x-1/2 bottom-6 w-[240px] h-[60px] bg-white rounded-lg shadow-2xl border border-purple-100 flex items-center px-5">
//               <div className="flex-1">
//                 <h4 className="text-[#0E2A46] font-bold text-lg leading-tight">Eddie Lenz</h4>
//                 <p className="text-[#704FE6] text-xs mt-1">Junior Instructor</p>
//               </div>
//               <div className="w-10 h-10 bg-[#E9E2FF] rounded-full flex items-center justify-center relative overflow-hidden">
//                 <div className="absolute -left-1 top-1/2 -translate-y-1/2 w-[18px] h-[7px] bg-[#704FE6] rotate-[-30deg]" />
