...
const ContactNewsletterFooter: React.FC = () => {
  return (
    <>
      {/* ================== NEWSLETTER & FOOTER SECTION ================== */}
        <div className="w-full mt-12 md:mt-24 lg:mt-32 relative">
          ...
          <div className="relative w-full z-10 px-4 sm:px-6">
            <div className="max-w-[1200px] mx-auto rounded-[24px] p-6 sm:p-10 md:p-14 shadow-xl overflow-hidden flex flex-col lg:flex-row items-center justify-between bg-cover bg-center bg-no-repeat"
                 style={{ backgroundImage: `url(${guest14Img})` }}>
                 
              <div className="w-full lg:w-1/2 mb-8 lg:mb-0 text-white text-center lg:text-left">
                <p className="text-[13px] font-semibold tracking-wider uppercase mb-2">Newsletter</p>
                <h2 className="text-[32px] md:text-[40px] font-extrabold leading-tight">Subscribe Our<br className="hidden lg:block"/>Newsletter</h2>
              </div>

              <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-end">
                <div className="flex w-full max-w-md bg-white rounded-full p-1.5 shadow-sm mb-6 overflow-hidden">
                  <input type="email" placeholder="Enter Email" className="flex-1 min-w-0 bg-transparent border-none outline-none px-4 text-[14px] text-gray-700" />
                  <button className="hidden sm:block bg-[#FF6B4A] hover:bg-[#ff6b4a]/90 text-white px-6 py-2.5 rounded-full text-[14px] font-semibold transition-colors flex-shrink-0">Subscribe</button>
                  <button className="sm:hidden bg-[#FF6B4A] hover:bg-[#ff6b4a]/90 text-white w-[38px] h-[38px] rounded-full flex items-center justify-center ml-2 transition-colors flex-shrink-0">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 text-white text-[13px] font-medium mr-auto sm:mr-0 lg:ml-auto">
                  ...
                  <div className="text-center sm:text-left">
                    ...
                    <a href="#" className="hover:underline flex items-center justify-center sm:justify-start gap-1 mt-0.5">Join them now <span>&rarr;</span></a>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Footer Content - Background pulled up behind banner */}
          <div className="relative bg-[#F5F4F9] pt-[120px] sm:pt-[150px] md:pt-[180px] lg:pt-[200px] pb-10 z-0 -mt-[80px] sm:-mt-[100px] md:-mt-[120px] lg:-mt-[140px]">
...
export default ContactNewsletterFooter;
