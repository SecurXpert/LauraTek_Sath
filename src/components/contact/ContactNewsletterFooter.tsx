            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 mb-16">
              ...
              <div className="col-span-1">
                ...
                <ul className="space-y-4 text-[#8896AB] text-[14px] font-medium">
                  <li><a href="#" className="hover:text-[#3B42A4]">About Us</a></li>
                  <li><a href="#" className="hover:text-[#3B42A4]">Our Courses</a></li>
                  <li><a href="#" className="hover:text-[#3B42A4]">Our Team</a></li>
                  <li><a href="#" className="hover:text-[#3B42A4]">Contact Us</a></li>
                </ul>
              </div>
