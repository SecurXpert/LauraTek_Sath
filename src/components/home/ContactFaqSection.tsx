...
const faqs = [
  {
    ...
    answer: "Lauratek offers courses across business, technology, data science, design, marketing, and personal development — with new categories added regularly based on industry demand."
  },
  {
    question: "Are the courses self-paced?",
    answer: "Yes. Every course is self-paced, so you can start, pause, and continue learning on a schedule that works for you."
  },
  {
    question: "Do I get a certificate after completing a course?",
    answer: "Yes. You'll receive a certificate of completion for every course you finish, which you can add to your resume or LinkedIn profile."
  },
  {
    question: "What is the cost of the courses?",
    answer: "Pricing varies by course length and content. You'll see the exact price listed on each course page before you enroll."
  }
];
        ...
        <section className="py-24 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1650px]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-24">
              ...
              {/* Contact Form Column */}
              <div className="bg-[#F3F4F6] rounded-[24px] p-10 lg:p-14 shadow-sm flex flex-col justify-center">
