...
const UnlockFeaturesCard: React.FC<UnlockFeaturesCardProps> = ({ setContactOpen }) => {
  return (
    <div className="bg-[#F4F1FF] rounded-[24px] p-6 lg:p-8 flex flex-col relative overflow-hidden h-full">
      ...
      <p className="text-[#6B7280] text-[14px] font-medium mb-6 max-w-[280px] leading-relaxed">
        Enroll in a course to access complete attendance features
      </p>
      
      <ul className="space-y-4 z-10 flex-grow relative w-full 2xl:max-w-[260px]">
        {[
          ...
          <li key={i} className="flex items-center gap-3">
            ...
            <span className="text-slate-700 text-[14px] font-medium leading-tight">{feature}</span>
          </li>
        ))}
      </ul>

      {/* Unified inline image placed below the content for all breakpoints */}
      <div className="w-[160px] h-[160px] md:w-[180px] md:h-[180px] lg:w-[220px] lg:h-[220px] 2xl:w-[240px] 2xl:h-[240px] self-center mt-8 mb-6 pointer-events-none shrink-0 z-10 relative">
