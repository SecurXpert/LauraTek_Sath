...
//                     Welcome back,{" "}
//                     <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Navya D!</span>
//                   </span>
...
//                       {card.label}
//                     </div>
//                     <div className="text-2xl font-bold text-gradient from-blue-600 to-indigo-600">
//                       {card.value}
//                     </div>
//                   </motion.div>
//                 ))}
...
//                 <motion.div 
//                   className="bg-white/70 backdrop-blur-sm rounded-xl shadow-md p-6 border border-white/20"
//                   variants={cardVariants}
//                   whileHover="hover"
//                 >
//                   <motion.div className="font-bold mb-4 text-lg flex items-center gap-2" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
...
//                       <motion.li
//                         key={i}
//                         className="flex justify-between items-center text-sm p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors duration-200"
...
//                 <motion.div 
//                   className="bg-white/70 backdrop-blur-sm rounded-xl shadow-md p-6 border border-white/20 flex flex-col items-center justify-center"
//                   variants={cardVariants}
//                   whileHover="hover"
//                 >
//                   <motion.div className="font-bold mb-4 text-lg flex items-center gap-2" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
...
//                   </div>
//                   <motion.button 
//                     className="px-6 py-2 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-lg font-medium hover:shadow-lg transition-all duration-300"
//                     variants={buttonVariants}
//                     whileHover="hover"
//                     whileTap="tap"
//                   >
...
//                     <motion.li 
//                       key={i} 
//                       className="text-sm p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors duration-200 cursor-pointer"
//                       initial={{ x: 10, opacity: 0 }}
//                       animate={{ x: 0, opacity: 1 }}
...
//                 </ul>
//                 <motion.button 
//                   className="mt-4 w-full text-indigo-600 text-sm font-medium hover:underline flex items-center gap-1 justify-center"
...
//                     <motion.li 
//                       key={i} 
//                       className="flex justify-between items-center text-sm p-3 bg-orange-50 rounded-lg hover:bg-orange-100 transition-colors duration-200"
//                       initial={{ x: -10, opacity: 0 }}
//                       animate={{ x: 0, opacity: 1 }}
...
//                 </ul>
//                 <motion.button 
//                   className="mt-4 w-full text-orange-600 text-sm font-medium hover:underline flex items-center gap-1 justify-center"
//                   whileHover={{ scale: 1.02 }}
//                 >
