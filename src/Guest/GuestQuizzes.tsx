...
import { getTechColor, getTopBorderColor, getLevelColor } from './components/Quizzes/quizUtils';
import QuizBanner from './components/Quizzes/QuizBanner';
import QuizAlert from './components/Quizzes/QuizAlert';
import QuizCard from './components/Quizzes/QuizCard';
import QuizSidebar from './components/Quizzes/QuizSidebar';
import QuizSuccessModal from './components/Quizzes/QuizSuccessModal';
...
const GuestQuizzes = () => {
  ...
  const fetchQuizzes = async () => {
    try {
      ...
      const response = await fetch('https://lauratek.in:8000/guest/quizzes', {
  ...
  return (
    <div className="px-4 lg:px-8 py-8 w-full max-w-[1400px] mx-auto min-h-screen bg-[#F8F9FB]">
      {/* Header Info */}
      <div className="mb-6">
