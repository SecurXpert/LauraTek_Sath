...
const MiddleCards: React.FC<MiddleCardsProps> = ({ 
  navigate, 
  upcomingLiveClass, 
  featuredCourse, 
  latestQuiz, 
  ...
  return (
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-4 xl:gap-6 mb-4">
        ...
        <div className="relative overflow-hidden bg-slate-900 group flex flex-col mx-auto w-full min-h-[360px] lg:h-full" style={{ maxWidth: '348.13px', borderRadius: '13.89px' }}>
          {upcomingLiveClass && (
          ...
          <div className="relative z-10 p-5 flex flex-col h-full">
            <div className="flex justify-between items-start mb-auto">
               ...
               <span className="bg-[#FF3B30] text-white text-[10px] font-bold px-2 py-0.5 rounded-full flex items-center gap-1 shadow-sm">
            ...
            <div>
              ...
              <button 
                ...
                className="w-full text-white text-[13px] font-bold py-3 rounded-[10px] flex items-center justify-between px-5 transition-opacity hover:opacity-90 shadow-sm"
        ...
        <div className="relative overflow-hidden bg-white group flex flex-col mx-auto w-full min-h-[360px] lg:h-full border border-gray-100 shadow-sm" style={{ maxWidth: '348.13px', borderRadius: '13.89px' }}>
          {featuredCourse && (
          ...
          <div className="relative z-10 p-5 flex flex-col h-full bg-gradient-to-t from-white/90 via-white/40 to-white/10">
            <div className="mb-auto">
               <span className="text-slate-800 text-[11px] font-bold bg-white/80 px-2.5 py-1 rounded-md shadow-sm">Featured Course</span>
            </div>
            ...
            <div className="mt-auto">
              ...
              <span className="inline-block bg-[#00A962] text-white text-[10px] font-bold px-2.5 py-1 rounded-md mb-4 shadow-sm">
                 Top Selling Course
              </span>
        ...
        {/* Quiz Challenge */}
        <div className="relative overflow-hidden bg-[#0F0C29] group flex flex-col mx-auto w-full min-h-[360px] lg:h-full" style={{ maxWidth: '348.13px', borderRadius: '13.89px' }}>
          <div className="relative z-10 p-5 flex flex-col h-full">
            <div className="mb-1">
            ...
            <div className="flex-1 flex justify-center items-center my-1 relative">
               <div className="w-[180px] h-[160px] relative z-10 flex items-center justify-center">
        ...
        {/* Daily Learning Tip */}
        <div className="p-5 lg:p-6 flex flex-col shadow-sm relative overflow-hidden mx-auto w-full min-h-[300px] lg:h-full" style={{ maxWidth: '348.13px', borderRadius: '13.89px', background: 'linear-gradient(180deg, #E7E8F9 0%, #EDE3F6 100%)' }}>
