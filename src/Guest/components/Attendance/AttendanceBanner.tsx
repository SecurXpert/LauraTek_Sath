...
const AttendanceBanner = () => {
  return (
    <div className="bg-[#F4F1FF] rounded-[24px] mb-6 flex flex-col md:flex-row overflow-hidden relative">
      <div className="py-0 pl-8 md:pl-10 lg:pl-12 flex-1 flex flex-col justify-center">
      ...
      <div className="md:w-[45%] lg:w-[50%] h-[250px] md:h-auto relative">
